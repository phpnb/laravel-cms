            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        <span><img alt="image" class="img-circle" src="{{ asset('/static/admin/img/profile_small.jpg') }}" /></span>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="{{ route('article-index') }}" data-index="0">文章列表</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="index_v2.html">文章分类</a>
                        </li>
                    </ul>
